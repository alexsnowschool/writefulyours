  ...
  if (req.method === "POST") {
    ...
    try {
      const params = {
        ...
        shipping_options: [
          // FREE SHIPPING
          { shipping_rate: "shr_1N40t1DNYZIfBslev7pkPe3F" },
        ],
        ...
        line_items: req.body.map((item) => {
          ...
          const newImage = img
            .replace(
              ...
              "https://cdn.sanity.io/images/bbuvfcjj/production/"
            )
            .replace("-webp", ".jpg"); // NOTE: put .jpg or .png if you don't use webp images
